		...
		function setResult(){
			...
			if (tweet.text != null){
				...
				*/				
				...
				result['stats'] = analyzeMood(tweet.text);
				result['location'] = getLocation();
				result['reach'] = tweet.user['followers_count'];
			...
			function getLocation(){
				...
				if (tweet.coordinates != null) {
					...
					var street = "";
					if (tweet.place['attributes'] != null){
						street = tweet.place['attributes']['street_address'] + ", " + tweet.place['attributes']['623:id'] + " "; 
					} 
			...
			function analyzeMood(text){
				...
				*/
				...
				function scoreWord(word, i){
					...
					var negators = "cant wont isnt not nor no arent never";
					var score = 1;
					if (i != 0){
